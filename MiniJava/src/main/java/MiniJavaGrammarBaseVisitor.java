...
public class MiniJavaGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MiniJavaGrammarVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitPrintLine(MiniJavaGrammarParser.PrintLineContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitEnd(MiniJavaGrammarParser.EndContext ctx) { return visitChildren(ctx); }
}